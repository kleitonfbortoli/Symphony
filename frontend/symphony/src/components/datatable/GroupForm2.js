...
export default function GroupForm2({ configurations }) {
    ...
    const [combo_itens2, setComboItens2] = useState([])
    ...
    function reloadComboItens()
    {
        ...
        System.post(configurations.url_get_combo_itens2, parans, (data) => {
            setComboItens2(data)
        });
    }
